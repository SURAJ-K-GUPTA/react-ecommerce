                    ...
                    <tr className="border-b border-gray-200 hover:bg-gray-100">
                      ...
                      <td className="py-3 px-6 text-center">
                        <div className="flex item-center justify-center">
                          <div className="w-6 mr-4 cursor-pointer transform hover:text-purple-500 hover:scale-150">
                            <EyeIcon
                              className="w-8 h-8"
                              onClick={(e) => handleShow(e, order)}
                            />
                          </div>
                          <div className="w-6 mr-2 cursor-pointer transform hover:text-purple-500 hover:scale-150">
                            <PencilIcon
                              className="w-8 h-8"
