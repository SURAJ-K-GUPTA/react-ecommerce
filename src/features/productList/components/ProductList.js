...
export default function ProductList() {
  ...
  const handleFilter = (e, section, option) => {
    ...
    //TODO : on sercer ir will support multiple categories
    if (e.target.checked) {
                            ...
                            {section.options.map((option, optionIdx) => (
                              ...
                              >
                                <input
                                  ...
                                  type="checkbox"
                                  defaultChecked={option.chsecked}
                                  onChange={(e) =>
        ...
        <div>
          ...
          >
            ...
            {Array.from({ length: totalPages }).map((el, index) => (
              ...
              ${
                index + 1 === page ? "bg-indigo-600 text-white" : "text-gray-800"
          ...
          <div className="mt-6 grid grid-cols-1 gap-x-6 gap-y-10 sm:grid-cols-2 lg:grid-cols-3 xl:gap-x-8">
            {products.map((product) => (
              <Link to={`/product-detail/${product.id}`} key={product.id}>
                <div className="group relative border-2 p-2 border-gray-200">
                  <div className="min-h-60 aspect-h-1 aspect-w-1 w-full overflow-hidden rounded-lg bg-gray-200 xl:aspect-h-8 xl:aspect-w-7">
                    <img
